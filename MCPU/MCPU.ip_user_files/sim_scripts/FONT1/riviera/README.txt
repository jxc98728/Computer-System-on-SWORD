...
#
# Generated by export_simulation on Mon Sep 24 14:50:13 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './FONT1.sh' script.
...
./FONT1.sh -noclean_files

For more information on the script, please type './FONT1.sh -help'.
